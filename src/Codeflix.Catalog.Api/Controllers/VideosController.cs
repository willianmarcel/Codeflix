...
using Codeflix.Catalog.Api.ApiModels.Video;
...
using Codeflix.Catalog.Application.UseCases.Video.GetVideo;
using Codeflix.Catalog.Application.UseCases.Video.ListVideos;
