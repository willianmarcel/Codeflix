...
using Codeflix.Catalog.Application.UseCases.Video.CreateVideo;
using Codeflix.Catalog.Domain.Exceptions;
using Codeflix.Catalog.Domain.Extensions;
using Codeflix.Catalog.Domain.Repository;
using FluentAssertions;
using Moq;
using DomainEntities = Codeflix.Catalog.Domain.Entity;
using UseCase = Codeflix.Catalog.Application.UseCases.Video.CreateVideo;

namespace Codeflix.Catalog.UnitTests.Application.Video.CreateVideo;
